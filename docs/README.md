...
Reference documentation for SuperSpecs. The skill files under
`../skills/` are the source of truth for agents; the documents in this
folder are the source of truth for humans.
...
- [`../AGENTS.md`](../AGENTS.md) — harness-agnostic agent instructions.
