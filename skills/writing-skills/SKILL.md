...
**Reference material:** `anthropic-best-practices.md` (bundled in this skill folder) is a copy of Anthropic's public documentation on skill authoring. It was written for Claude but the patterns generalize to any agent that loads `SKILL.md` files (including Cursor). Read it for context-window discipline, frontmatter conventions, and bundling guidance.
...
## Red-Green-Refactor Mapping for Skill Authoring

| Concept | Skill Creation |
|---------|----------------|
| **Test case** | Pressure scenario with subagent |
| **Production artifact** | Skill document (SKILL.md) |
| **RED** | Agent violates rule without skill (baseline) |
| **GREEN** | Agent complies with skill present |
| **Refactor** | Close loopholes while maintaining compliance |
| **Write test first** | Run baseline scenario BEFORE writing skill |
| **Watch it fail** | Document exact rationalizations agent uses |
| **Minimal artifact** | Write skill addressing those specific violations |
...
- Project-specific conventions (put in `.cursor/rules/`)
...
## The Iron Law (Red-Green-Refactor for skills)
...
**REQUIRED BACKGROUND:** The Red-Green-Refactor mapping at the top of this skill explains why this matters. Same principles apply to documentation as to code.
...
Follow the cycle described in the mapping at the top of this file:
...
## Skill Creation Checklist (Red-Green-Refactor)
...
**Creating skills uses Red-Green-Refactor for process documentation.**

Iron Law: No skill without a failing test (pressure scenario) first.
